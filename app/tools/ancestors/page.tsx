...
export default async function AncestorsToolPage() {
  ...
  return (
    ...
    >
      <p className="eyebrow eyebrow-lg mb-3">{tr("mkt.anc.s1Eyebrow")}</p>
      ...
      <p className="eyebrow eyebrow-lg mb-3 mt-12">{tr("mkt.anc.s2Eyebrow")}</p>
      <h2 className="display text-2xl md:text-3xl mb-6 leading-tight">
        {tr("mkt.anc.s2Title")}
      </h2>
      <p className="text-[var(--foreground-muted)] leading-relaxed mb-8">
      ...
      <p className="eyebrow eyebrow-lg mb-3 mt-12">{tr("mkt.anc.s3Eyebrow")}</p>
      <p className="text-[var(--foreground-muted)] leading-relaxed mb-8">
        {tr("mkt.anc.s3Body")}
      </p>

      <p className="eyebrow eyebrow-lg mb-3 mt-12">{tr("mkt.anc.s4Eyebrow")}</p>
      <p className="text-[var(--foreground-muted)] leading-relaxed mb-8">
        {tr("mkt.anc.s4Body")}
      </p>
    </MarketingToolLayout>
