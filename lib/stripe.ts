 ...
 *   - $29.95 / month  (STRIPE_PRICE_MONTHLY)
 *   - $299.95 / year  (STRIPE_PRICE_ANNUAL, ~2.5 months free vs monthly)
 *
 ...
 *   STRIPE_PRICE_MONTHLY     price_... id for the $29.95/mo plan
 *   STRIPE_PRICE_ANNUAL      price_... id for the $299.95/yr plan
...
export function planLabel(plan: PlanKey | "gift" | null): string {
  if (plan === "annual") return "Annual ($299.95/year)";
  if (plan === "monthly") return "Monthly ($29.95/month)";
