...
export const BURN_GEOM: Record<string, { cx: number; top: number; bot: number }> = {
  ...
  "bayberry": { cx: 48.1, top: 11, bot: 92 },
  "better-business": { cx: 46.3, top: 11, bot: 92 },
  "bingo": { cx: 48.9, top: 11, bot: 91.9 },
  ...
  "come-to-me": { cx: 48.8, top: 11, bot: 92 },
  ...
  "indian-house-blessing": { cx: 45.9, top: 11, bot: 91.9 },
  ...
  "lucky-7-11": { cx: 46.5, top: 11, bot: 92 },
  "money-drawing": { cx: 50.3, top: 5.2, bot: 91.9 },
  "ochosi": { cx: 48.8, top: 11, bot: 90.9 },
  "open-road": { cx: 50, top: 3.7, bot: 92 },
  "peace": { cx: 48.6, top: 11, bot: 92 },
  "peace-in-the-home": { cx: 50, top: 11, bot: 92 },
  "psalm-23": { cx: 48.6, top: 11, bot: 92 },
