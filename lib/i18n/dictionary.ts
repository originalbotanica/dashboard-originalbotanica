...
const en: Dict = {
  ...
  "dash.altarBody": "For an intention, for a desire. It may be for protection, for someone you love who needs a prayer. For your own success and abundance. Choose your candle, write your petition, and let it burn on your altar. Add it to the community altar so others hold the intention with you.",
  ...
  "lcf.burnsSeven": "Your candle burns for seven days, like a true veladora.",
...
const es: Dict = {
  ...
  "dash.altarBody": "Por una intención, por un deseo. Puede ser por protección, por alguien que amas y necesita una oración. Por tu propio éxito y abundancia. Elige tu vela, escribe tu petición y déjala arder en tu altar. Agrégala al altar comunitario para que otros sostengan la intención contigo.",
  ...
  "lcf.burnsSeven": "Tu vela arde por siete días, como una verdadera veladora.",
