...
const en: Dict = {
  ...
  "off.shop": "Real ancestor money and offering tools are at the botanica — members save 10%.",
...
const es: Dict = {
  ...
  "off.shop": "El dinero de los ancestros y las herramientas de ofrenda reales están en la botánica — los miembros ahorran 10%.",
