...
const en: Dict = {
  ...
  "dash.altarBody": "For an intention, for a desire. It may be for protection, for someone you love who needs a prayer. For your own success and abundance. Choose your candle, write your petition, and let it burn on your altar. Return each day to feed the flame, and add it to the community altar so others hold the intention with you.",
  ...
  "lp.toolAltarBody": "Light a candle for an intention, for protection, for someone you love. Return each day it burns to feed the flame and keep the intention alive.",
  ...
  "lcf.burnsSeven": "Your candle burns for seven days, like a true veladora. Return each day to feed its flame.",
  ...
  // tending (feeding the flame)
  "tend.btn": "Feed the flame",
  "tend.pending": "Feeding the flame…",
  "tend.done": "The flame is fed. It burns brighter today.",
  ...
  "mkt.altar.feedTitle": "Feed the flame, every day it burns.",
  "mkt.altar.feedBody":
    "A candle is not lit and forgotten. Return to it each day it burns. One touch feeds the flame: the room falls dark, the fire flares, and your intention is held again. Seven days of returning, seven days of devotion.",
...
const es: Dict = {
  ...
  "dash.altarBody": "Por una intención, por un deseo. Puede ser por protección, por alguien que amas y necesita una oración. Por tu propio éxito y abundancia. Elige tu vela, escribe tu petición y déjala arder en tu altar. Vuelve cada día para alimentar la llama, y agrégala al altar comunitario para que otros sostengan la intención contigo.",
  ...
  "lp.toolAltarBody": "Enciende una vela por una intención, por protección, por alguien que amas. Vuelve cada día que arda para alimentar la llama y mantener viva la intención.",
  ...
  "lcf.burnsSeven": "Tu vela arde por siete días, como una verdadera veladora. Vuelve cada día para alimentar su llama.",
  ...
  // tending (feeding the flame)
  "tend.btn": "Alimenta la llama",
  "tend.pending": "Alimentando la llama…",
  "tend.done": "La llama está alimentada. Hoy arde más fuerte.",
  ...
  "mkt.altar.feedTitle": "Alimenta la llama, cada día que arda.",
  "mkt.altar.feedBody":
    "Una vela no se enciende y se olvida. Vuelve a ella cada día que arda. Un toque alimenta la llama: la sala se oscurece, el fuego se aviva, y tu intención se sostiene de nuevo. Siete días de volver, siete días de devoción.",
