...
const en: Dict = {
  ...
  "lcf.burnsSeven": "Your candle burns for seven days. Return each day to feed its flame.",
...
const es: Dict = {
  ...
  "lcf.burnsSeven": "Tu vela arde por siete días. Vuelve cada día para alimentar su llama.",
